...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    "github_distribution_base_url": "https://raw.githubusercontent.com/luckasgh9170/luckasapp/main/distribution",
    "auto_sync": True,
    "sync_interval": 5,
    "background_sync": False,
    "service_enabled": True,
    "service_health_interval": 5,
    "service_health_batch": 24,
    "service_health_max_age_minutes": 60,
    "service_validation_workers": 4,
    "cleanup_min_failures": 5,
    "cleanup_max_age_hours": 48,
    "set_system_proxy_on_connect": False,
